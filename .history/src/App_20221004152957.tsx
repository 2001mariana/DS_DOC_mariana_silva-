...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div>
        <ButtonDanger label='' size='small' />
        <ButtonDanger label='d' size='medium' />
        <ButtonDanger label='' size='large' />
      </div>
      

      <div>
        <ButtonSuccess label='s' size='small' />
        <ButtonSuccess label='su' size='medium' />
        <ButtonSuccess label='s' size='large' />
      </div>
    </div>
  );
}
