import { ABbutton, ABInput, AbInputQuant, ABOptionGroup, ABTag, Card } from 'designsystem-marianasilva';
import ButtonDanger from 'designsystem-marianasilva/dist/components/ButtonDanger';
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <ButtonDanger label='success - small' size='small' />
      <ButtonDanger label='success - medium' size='medium' />
      <ButtonDanger label='success - large' size='large' />
    </div>
  );
}
