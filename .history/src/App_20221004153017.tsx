  ...
  return (
    <div className="App">
      ...
      <div>
        ...
        <ButtonDanger label='custom textm' size='medium' />
        <ButtonDanger label='custom text' size='large' />
      </div>
      

      <div>
        <ButtonSuccess label='custom textl' size='small' />
        <ButtonSuccess label='custom textum' size='medium' />
        <ButtonSuccess label='custom texte' size='large' />
      </div>
    </div>
  );
}
