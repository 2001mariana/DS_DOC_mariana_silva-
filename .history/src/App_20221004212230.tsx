import { ABbutton, ABInput, AbInputQuant, ABOptionGroup, ABTag, ButtonBlack, ButtonBlue, ButtonDanger, ButtonGreen, ButtonPink, ButtonYellow, Card } from 'designsystem-marianasilva';
...
function App() {
  ...
  return (
    ...
    <h2>Variações do ButtonDanger</h2>
      ...
      <p>{`<ButtonLed label="custom text" size="small" variant="outlined"/>`}</p>
      <div className='test'>
