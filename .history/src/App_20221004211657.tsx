...
function App() {
  ...
  return (
    ...
    <h2>Variações do ButtonDanger</h2>
      ...
      <div className='test'>
        <ButtonPink label='custom text' size='small' variant='' intensity='light' />
        <ButtonPink label='custom text' size='medium' variant='' intensity='light' />
        <ButtonPink label='custom text' size='large' variant='' intensity='light' />
      </div>
