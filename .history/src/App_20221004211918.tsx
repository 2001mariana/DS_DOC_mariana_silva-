import { ABbutton, ABInput, AbInputQuant, ABOptionGroup, ABTag, ButtonBlue, ButtonDanger, ButtonGreen, ButtonPink, Card } from 'designsystem-marianasilva';
...
function App() {
  ...
  return (
    ...
    <h2>Variações do ButtonDanger</h2>
      ...
      <h2>Variações do Button</h2>
      <p>{`<Button label="custom text" size="small" variant="outlined"/>`}</p>
      <div className='test'>
        <Button label='custom text' size='small' />
        <Button label='custom text' size='medium' />
        <Button label='custom text' size='large' />
      </div>

      <div className='test'>
        <Button label='custom text' size='small' variant='solid' />
        <Button label='custom text' size='medium' variant='solid' />
        <Button label='custom text' size='large' variant='solid' />
      </div>      
