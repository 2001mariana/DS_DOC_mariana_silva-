...
function App() {
  ...
  return (
    ...
    >
      <div className='test'>
        <ABbutton color='Secondary' text='custall' size='small' />
        <ABbutton color='Secondary' text='custrge' size='large' />
      </div>

      <div className='test'>
        <ABbutton color='Primary' text='cust' size='small' />
        <ABbutton color='Primary' text='cust' size='large' />
      </div>
    </ComponentVariable>
