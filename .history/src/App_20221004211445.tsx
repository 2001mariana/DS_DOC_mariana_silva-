...
function App() {
  ...
  return (
    ...
    <h2>Variações do ButtonDanger</h2>
      ...
      <h2>Variações do <ButtonPink></ButtonPink></h2>
      <p>{`<<ButtonPink></ButtonPink> label="your custom text" size="small | medium | large" variant="outlined | solid"/>`}</p>
      <div className='test'>
        <<ButtonPink></ButtonPink> label='custom text' size='small' />
        <<ButtonPink></ButtonPink> label='custom text' size='medium' />
        <<ButtonPink></ButtonPink> label='custom text' size='large' />
      </div>

      <div className='test'>
        <<ButtonPink></ButtonPink> label='custom text' size='small' variant='solid' />
        <<ButtonPink></ButtonPink> label='custom text' size='medium' variant='solid' />
        <<ButtonPink></ButtonPink> label='custom text' size='large' variant='solid' />
      </div>
