...
function App() {
  ...
  return (
    ...
    <h2>Variações do ButtonDanger</h2>
      ...
      <div className='test'>
        <ButtonPink label='custom text' size='small' variant='ou' intensity='light' />
        <ButtonPink label='custom text' size='medium' variant='ou' intensity='light' />
        <ButtonPink label='custom text' size='large' variant='ou' intensity='light' />
      </div>
