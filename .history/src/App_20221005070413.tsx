...
function App() {
  ...
  return (
    ...
    <ComponentVariable title='Variações do ButtonDanger' subtitle='<ButtonDanger label="custom text"  size="small" | "medium" | "large" variant="outlined" | "solid" />' >
      <div className='test'>
      ...
      <p>{`<ButtonYellow label="custom text"  size="small" | "medium" | "large" variant="outlined" | "solid" />`}</p>
      <div className='test'>
      ...
      <p>{`<ButtonBlue label="custom text"  size="small" | "medium" | "large" variant="outlined" | "solid" />`}</p>
      <div className='test'>
      ...
      <p>{`<ButtonBlack label="custom text" size="small" | "medium" | "large" variant="outlined" | "solid" />`}</p>
      <div className='test'>
