...
function App() {
  ...
  return (
    ...
    <h2>Variações do ButtonDanger</h2>
      ...
      <div className='test'>
        <ButtonPink label='custom text' size='small' variant='s' intensity='dark' />
        <ButtonPink label='custom text' size='medium' variant='s' intensity='dark' />
        <ButtonPink label='custom text' size='large' variant='s' intensity='dark' />
      </div>
