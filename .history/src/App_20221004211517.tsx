...
function App() {
  ...
  return (
    ...
    <h2>Variações do ButtonDanger</h2>
      ...
      <p>{`<ButtonPink label="your custom text" size="small | medium | large" variant="outlined | solid"/>`}</p>
      <div className='test'>
        <ButtonPink label='custom text' size='small' intensity='' />
        <ButtonPink label='custom text' size='medium' intensity='' />
        <ButtonPink label='custom text' size='large' intensity='' />
      </div>
