...
function App() {
  ...
  return (
    ...
    >
      <div className='test'>
        <ABbutton color='Secondary' text='all' size='small' />
        <ABbutton color='Secondary' text='rge' size='large' />
      </div>

      <div className='test'>
        <ABbutton color='Primary' text='' size='small' />
        <ABbutton color='Primary' text='' size='large' />
      </div>
    </ComponentVariable>
